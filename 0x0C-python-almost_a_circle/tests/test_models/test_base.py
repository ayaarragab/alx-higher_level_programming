...
class test_save_to_file(unittest.TestCase):
    ...
    def test_for_trancuate(self):
        """Make sure that mode is w
        """
        with open('Square.json') as f:
            CurrentContent1 = f.read()
        sq1 = Square(10, 3, 5)
        sq2 = Square(6, 50, 1, 4)
        listOfDicts = [sq1.to_dictionary(), sq2.to_dictionary()]
        listOfObjs = [sq1, sq2]
        ...
        with open('Square.json') as f:
            ...
            CurrentContent2 = f.read()
        self.assertFalse(CurrentContent1 == CurrentContent2)
